...
class Investor(models.Model):
    ...
    def __str__(self):
        # Вывод в тег SELECT 
        return "{}, {}".format(self.fio, self.phone_number)
...
class Binding(models.Model):
    ...
    investor = models.ForeignKey(Construction, related_name='binding_investor', on_delete=models.CASCADE)
    class Meta:
        # Параметры модели
        # Переопределение имени таблицы
        db_table = 'binding'
...
class Investments(models.Model):
    ...
    investor = models.ForeignKey(Construction, related_name='investments_investor', on_delete=models.CASCADE)
...
class Coming(models.Model):
    ...
    def __str__(self):
        ...
        return "#{} {}".format(self.numb, self.datei)
